...
describe('Service Tests', () => {
    describe('OTHER Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(OTHERService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/others';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a OTHER', () => {
                service.create(new OTHER(null)).subscribe(received => {
            ...
            it('should update a OTHER', () => {
                service.update(new OTHER(123)).subscribe(received => {
